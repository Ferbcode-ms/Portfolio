...
const MainContent = () => {
  ...
  return (
    <div className="relative w-[65%] rounded-[20px] border-[1px] border-solid border-jet bg-eerie-black-2 p-[30px] max-xl:w-full max-md:p-4">
      {/* Navigation */}
      <nav className="absolute right-0 top-0 z-40 w-max rounded-bl-[20px] rounded-tr-[20px] border-[1px] border-solid border-jet bg-eerie-black-1 px-[8px] shadow-none backdrop-blur-[10px] max-md:fixed max-md:bottom-0 max-md:right-0 max-md:top-auto max-md:w-full max-md:rounded-lg max-md:p-2">
